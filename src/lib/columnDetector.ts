...
const FIELD_PATTERNS: Record<string, string[]> = {
  ...
  // State patterns — only compound forms like "state/province"; standalone "region" and "province" are too broad
  state: ['state/province', 'state_province', 'state province', 'state/region', 'state_region', 'state region', 'state'],
