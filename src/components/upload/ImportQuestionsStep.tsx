...
export function ImportQuestionsStep() {
  ...
  // If no import questions, still show the object type selector and continue button
      ...
      <div className="space-y-6">
        <div>
          ...
          <p className="text-gray-600 mt-1">
            Select your object type to continue.
          </p>
        </div>
  ...
  return (
    <div className="space-y-6">
      <div>
        <h2 className="text-xl font-semibold text-gray-900">Import Questions</h2>
        <p className="text-gray-600 mt-1">
          Select your object type and answer the following questions to add data to your import.
        </p>
      </div>
