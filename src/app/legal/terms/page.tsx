        ...
        <div className="prose prose-gray max-w-none space-y-6">
          ...
          <section>
            ...
            <p className="text-gray-700 mt-2">
              ...
              servers. See our <Link href="/legal/privacy" className="text-primary-600 hover:underline">Privacy Policy</Link> for
          ...
          <div className="border-t border-gray-200 pt-4 mt-8">
            <p className="text-sm text-gray-500">
              See also: <Link href="/legal/privacy" className="text-primary-600 hover:underline">Privacy Policy</Link>
              {' | '}
